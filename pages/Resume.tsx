      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-8 pt-12 print:pt-0 print:px-0 print:max-w-none">
        ...
        <div>
          ...
          <div className="space-y-16 print:space-y-8">
            {/* about */}
            <section>
              <h2 className="text-sm font-semibold uppercase tracking-wider text-muted dark:text-gray-500 print:text-gray-500 mb-6 print:mb-3">Summary</h2>
              <p className="text-primary dark:text-gray-200 print:text-black leading-relaxed max-w-2xl whitespace-pre-line">
                {RESUME_DATA.about}
              </p>
            </section>
